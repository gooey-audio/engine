...
export default function WasmTest() {
  ...
  async function loadWasm() {
    ...
    try {
      ...
      setIsLoaded(true);
      console.log(
        "WASM Stage with 4 oscillators, kick drum, hi-hat, snare, and Web Audio loaded successfully!"
      );
    } catch (error) {
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mt-4 p-4 bg-blue-900/20 border border-blue-600/30 rounded">
        ...
        <ul className="text-sm space-y-1 text-blue-100">
          ...
          <li>
            • <strong>16-Step Sequencer</strong>: Automated pattern playback
            with real-time step programming
          </li>
          <li>
            • <strong>Sequencer Controls</strong>: Play/Stop, Reset, Clear All,
            BPM control (60-180), and real-time pattern editing
          </li>
          <li>
            • <strong>Pattern Programming</strong>: Individual step control for
            each of the 4 instruments with 16 steps per pattern
          </li>
          <li>
            • <strong>Visual Feedback</strong>: Real-time current step indicator
            with pulse animation during playback
          </li>
          <li>
      ...
      <div className="mt-4 p-4 bg-yellow-900/20 border border-yellow-600/30 rounded">
        ...
        <ol className="list-decimal list-inside text-sm space-y-1 text-yellow-100">
          <li>
            ...
            oscillators, kick drum, hi-hat, and snare
          </li>
          ...
          <ul className="list-disc list-inside ml-4 text-xs space-y-0.5 text-yellow-200">
            <li>
              <strong>Pattern Programming:</strong> Click grid squares to
              enable/disable steps for each instrument
            </li>
            <li>
              <strong>Transport Controls:</strong> Use Play/Stop to control
              automated playback
            </li>
            <li>
              <strong>BPM Control:</strong> Adjust tempo from 60-180 BPM using
              the slider
            </li>
            <li>
              <strong>Reset:</strong> Return to step 1 without stopping playback
            </li>
            <li>
              <strong>Clear All:</strong> Remove all programmed steps from all
              instruments
            </li>
            <li>
              <strong>Real-time Editing:</strong> Add or remove steps while the
              sequencer is playing
            </li>
            <li>
              <strong>Visual Feedback:</strong> Watch the current step indicator
              pulse through the pattern
            </li>
          </ul>
